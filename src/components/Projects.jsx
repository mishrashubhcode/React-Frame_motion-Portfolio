                ...
                {PROJECTS.map((project, index) => (
                    <div key={index} className="mb-12 flex flex-wrap lg:justify-center">
                        ...
                        <motion.div
                            ...
                            {project.features && (
                                <div className="mb-4">
                                    <h7 className="text-lg font-medium text-neutral-200 mb-2 block">Key Features:</h7>
                            ...
                            {project.implementation && (
                                <div className="mb-4">
                                    <h7 className="text-lg font-medium text-neutral-200 mb-2 block">Technical Implementation:</h7>
                            ...
                            {project.impact && (
                                <div className="mb-4">
                                    <h7 className="text-lg font-medium text-neutral-200 mb-2 block">Impact & Results:</h7>
                            ...
                            {/* Technologies */}
                            <div className="mb-4">
                                <h7 className="text-lg font-medium text-neutral-200 mb-2 block">Technologies Used:</h7>
